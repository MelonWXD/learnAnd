...
public class Triangle {
    ...
    public Triangle() {
        ...
        int vertexShader = CameraGLRender.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = CameraGLRender.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
