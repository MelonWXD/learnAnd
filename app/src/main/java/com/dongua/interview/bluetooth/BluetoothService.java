...
package com.dongua.interview.bluetooth;
...
//    }
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BlueToothActivty.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BlueToothActivty.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BlueToothActivty.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BlueToothActivty.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BlueToothActivty.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BlueToothActivty.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BlueToothActivty.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
	                    ...
	                    mHandler.obtainMessage(BlueToothActivty.MESSAGE_READ, bytes, -1, buffer)
	                            .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BlueToothActivty.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
